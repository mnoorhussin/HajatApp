...
const faqs = [
  {
    ...
    answer: 'الأمر بسيط جداً! قم بتحميل التطبيق، واكتب طلبك في "المربع السحري"، وحدد موقعك، وسيتكفل مندوبو التوصيل بالباقي.'
  },
  {
  ...
  },
  {
    ...
    answer: 'نعم، ندعم الدفع نقداً عند الاستلام بالإضافة إلى التحويل البنكي عبر التطبيقات المصرفية المتاحة.'
  },
  {
    question: 'كيف أصبح مندوب توصيل في حاجات؟',
    answer: 'إذا كانت لديك وسيلة نقل (توك توك، دراجة نارية، سيارة) وترغب في زيادة دخلك، يمكنك التسجيل عبر أيقونة "انضم كمندوب توصيل" في التطبيق أو عبر الموقع.'
  }
];
